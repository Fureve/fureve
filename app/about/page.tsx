      ...
      <section className="pt-40 pb-24 md:pb-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="font-sans text-base md:text-lg text-charcoal/70 max-w-2xl mx-auto leading-relaxed mb-16">
            FUREVE (For Eve) was founded on a belief; jewelry should be special to oneself. We work with fine and ethically sourced metals and other materials to create curated collections and fully bespoke pieces — each one designed in close collaboration with you, from start to finish.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8">
            ...
            <div>
              ...
              <p className="font-sans text-sm text-charcoal/70 leading-relaxed">
                Matching sets designed entirely around you — necklaces,
                earrings, bracelets built as one story.
              </p>
            </div>
          </div>
        </div>
